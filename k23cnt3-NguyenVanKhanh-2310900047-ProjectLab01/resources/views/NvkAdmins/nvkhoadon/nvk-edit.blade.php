...
@section('content-body')
    <div class="container border">
        <div class="row">
            <div class="col">
                <!-- Update the form action route to pass the nvkMaKhachHang as a parameter -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="nvkTongTriGia" name="nvkTongTriGia" value="{{ old('nvkTongTriGia', $nvkhoadon->nvkTongTriGia) }}" >
                                @error('nvkTongTriGia')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label for="nvkTrangThai1">Đang Sử Lý</label>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('nvkadmins.nvkhoadon') }}" class="btn btn-primary">Trở lại</a>
                        </div>
                    </div>
                </form>
            </div>
